---
title: "Google to build data center in Minnesota with new solar, wind power and battery storage"
source: "Unknown"
url: "https://www.cnbc.com/2026/02/24/google-to-build-data-center-in-minnesota-with-solar-wind-and-battery-storage.html"
published: "2026-02-24T19:06:16.000Z"
category: "finance"
summary: "\"What Google is doing is ensuring that when we show up, we aren't putting additional costs on other ratepayers,\" its head of data center energy told CNBC."
---
...
[Alphabet](https://www.cnbc.com/quotes/GOOGL/)'s Google will build its first data center in Minnesota and deploy a significant amount of new renewable energy in the state under an agreement with utility [Xcel](https://www.cnbc.com/quotes/XEL/), the companies announced Tuesday.

The data center will be located on a 480-acre site at [Pine Island](https://pineislandmn.gov/skyway), a town of about 4,000 people some 70 miles southeast of Minneapolis. Google had not publicly disclosed its role in the project previously. The facility will be used for artificial intelligence applications as well as Google's broader cloud business.
...
The town's residents have formed a group called "[Stop the Pine Island Data Center](https://www.facebook.com/groups/1117176807284432)." The [Minnesota Center for Environmental Advocacy](https://www.mncenter.org/press-release-pine-island-data-center-environmental-study-appealed) filed a lawsuit in October challenging the environmental review of the project.

Pine Island's city council approved two preliminary development plans for the data center in December, according to [local broadcaster KTTC](https://www.kttc.com/2025/12/17/pine-island-city-council-advances-data-center-project-despite-lawsuit/). It also approved financial incentives that include a $36 million tax abatement in February, [according to the outlet](https://www.kttc.com/2026/02/05/pine-island-city-council-approves-financial-incentives-data-center-project/).

City Administrator Elizabeth Howard said Pine Island would collect more than $130 million in tax revenue from the project, [according to KTTC](https://www.kttc.com/2026/02/05/pine-island-city-council-approves-financial-incentives-data-center-project/).

Minnesota has not been a major data center market in the past but the big tech companies are increasingly eyeing the state. There are currently 74 data centers in Minnesota. Virginia, the largest market worldwide, has 570 such facilities, according to the [Data Center Map](https://www.datacentermap.com/usa/).

_Correction: This article has been updated to correct the name of the Minnesota Public Utilities Commission._
