...
published: "2026-03-21T12:00:01.000Z"
category: "finance"
summary: "At Nvidia's GTC conference this week, CEO Nvidia Jensen Huang dedicated a major part of his keynote to OpenClaw, a technology that didn't exist six months ago."
---
...
OpenClaw, as that creation is known, has enjoyed such a rapid ascent since then that it took center stage this week at GTC, [Nvidia's](https://www.cnbc.com/quotes/NVDA/) annual conference, where the leader of the world's most valuable company called it "the most popular, open-source project in the history of humanity."

"This is definitely the next ChatGPT," Nvidia CEO Jensen Huang [told CNBC's Jim Cramer](https://www.cnbc.com/2026/03/17/nvidia-ceo-jensen-huang-says-openclaw-is-definitely-the-next-chatgpt.html) on the sidelines of the developer event in Santa Clara, California. In his keynote, Huang described OpenClaw as the go-to option for building AI agents that can perform tasks like scouting [eBay](https://www.cnbc.com/quotes/EBAY/) for deals and then placing bids, and said it "exceeded what Linux did in 30 years" in mere weeks.

The phenomenon is so pivotal to Nvidia that the chipmaker said at GTC that it's building free accompanying security services — packaged as [NemoClaw](https://www.cnbc.com/2026/03/19/column-jensen-huang-doesnt-need-a-new-chip-he-needs-a-new-moat.html) — intended to help spur more adoption of OpenClaw and get large businesses comfortable with its use.
...
![Nvidia CEO Jensen Huang: OpenClaw is 'definitely the next ChatGPT'](https://image.cnbcfm.com/api/v1/image/108279255-3ED3-MM-C-BLOCK-SHORT-031726.jpg?v=1773789227&w=750&h=422&vtcrop=y)
...
Hendrickson said developers have been [gravitating](https://www.cnbc.com/2026/03/18/china-openclaw-baidu-tencent-ai.html) to the Chinese AI models because they are good enough and cheaper to run than the powerful proprietary models from the likes of OpenAI, Anthropic and [Google](https://www.cnbc.com/quotes/GOOGL/). And because developers use OpenClaw on their personal computers like [Apple](https://www.cnbc.com/quotes/AAPL/) Mac Minis to manage their fleets of always-operating AI agents, they've discovered it's far more economical than tapping the cloud to access the bigger models.
...
Anthropic has been debuting similar OpenClaw-like features, such as a new [channels](https://code.claude.com/docs/en/channels) tool.

And last month, in a Sunday [post on X](https://x.com/sama/status/2023150230905159801), OpenAI CEO Sam Altman [announced](https://www.cnbc.com/2026/02/15/openclaw-creator-peter-steinberger-joining-openai-altman-says.html) that Peter Steinberger, the developer of OpenClaw, was joining the AI company and that the service he created would "live in a foundation as an open source project that OpenAI will continue to support."
...
Cohen and his brother have since shuttered their AI marketing firm, created a new startup called NanoCo that will offer paid services to accompany NanoClaw, and [partnered](https://www.docker.com/press-release/nanoclaw-partners-with-docker-to-run-ai-agents-safely/) last week with [container technology company Docker](https://www.cnbc.com/2015/02/25/dockers-rise-from-sleeper-to-open-source-king.html) to solidify itself as an OpenClaw competitor.

![OpenClaw fever hits China](https://image.cnbcfm.com/api/v1/image/108279806-17738585291773858526-44658092357-1080pnbcnews.jpg?v=1773858528&w=750&h=422&vtcrop=y)
...
Venture capitalist Jerry Chen of Greylock, an Anthropic [investor](https://www.cnbc.com/2025/10/20/openai-investor-reid-hoffman-calls-anthropic-one-of-the-good-guys.html), said OpenClaw's success in showing what a world of "intelligent agents" can look like doesn't take away from the importance of the underlying foundation models, which he still sees as more powerful than the so-called open-weight alternatives.
...
Jay Goldberg of Seaport Research Partners is the lone Nvidia analyst among roughly 70 tracked by FactSet with a sell recommendation on the stock. He [initiated](https://www.bloomberg.com/news/articles/2025-04-30/nvidia-gets-rare-sell-rating-as-seaport-says-ai-fully-priced-in) his coverage in April after the stock had already rocketed from the AI boom, but the shares kept rallying and are up more than 60% since his sell rating.
...
**WATCH**: [Nvidia's one of the fastest growing companies with one of the lowest valuations](https://www.cnbc.com/video/2026/03/18/nvidias-one-of-the-fastest-growing-companies-with-one-of-the-lowest-valuations-says-jim-cramer.html).

![Nvidia's one of the fastest growing companies with one of the lowest valuations, says Jim Cramer](https://image.cnbcfm.com/api/v1/image/108280011-4ED5-REQ-031826-MMABLOCKSHORT.jpg?v=1773873780&w=750&h=422&vtcrop=y)
