...
source: "
                    Scott K. Johnson
                "
url: "https://arstechnica.com/science/2026/03/a-bit-of-good-news-its-possible-to-turn-around-a-groundwater-crisis/"
published: "2026-03-23T16:05:51.000Z"
category: "tech"
summary: "Analyzing dozens of cases around the world yields some practical lessons."
---
Wishing for well water

Analyzing dozens of cases around the world yields some practical lessons.

Generally, when you hear “water use” and “sustainability,” you expect those words to be followed by some bad news. Humanity’s enduring ability to ignore the math of declining water supplies is almost impressive. But there _are_ cases where actions have successfully reversed our loss of water resources. A new paper in Science by Scott Jasechko of the University of California, Santa Barbara, examines documented cases of groundwater recovery around the world to identify which strategies have worked.

Groundwater is invaluable for many reasons. For one, it’s (usually) cleaner than surface water. It’s also right under your feet and often close enough to the surface that it doesn’t take much energy to pump it up. And there’s _loads_ of it down there, no matter the season. Because of this, humans use a lot of it for drinking water, agriculture, and every other use you can think of.
...
Jasechko compiled 67 published studies documenting cases where groundwater levels rose after spending at least a decade in decline. (You can explore [all 67 cases on a map](https://maphub.net/jasechko/solutions-for-depleted-aquifers).) His goal was to find commonalities and see if we could learn any general lessons by zooming out to this bigger picture.

[![World map of cases with time series plots of groundwater levels for some of them.](https://cdn.arstechnica.net/wp-content/uploads/2026/03/science.adu1370-f1-1024x717.jpg)](https://cdn.arstechnica.net/wp-content/uploads/2026/03/science.adu1370-f1.jpg)

Groundwater level data for some of the 67 cases on the map, color-coded by the type of action that drove recovery.

Groundwater level data for some of the 67 cases on the map, color-coded by the type of action that drove recovery. Credit: [Jasechko/Science](https://www.science.org/doi/10.1126/science.adu1370)

## How to guide

In 81 percent of the cases, an alternative source of water was part of the answer—change didn’t come about just by reducing overall use through conservation (though some locations also did that). Many times, this involved large infrastructure work, like China’s massive [South-to-North Water Diversion Project](https://en.wikipedia.org/wiki/South%E2%80%93North_Water_Transfer_Project) or the Doosti Dam on the border of Iran and Turkmenistan. Other cases involved much smaller connections. Osaka, Japan, simply began using water from the river that flows right through the city, for example.
...
This is a little trickier than piping water into a surface reservoir. For a shallow aquifer, the rate at which water can soak into the ground is limited by the properties of the sediment or rock, so achieving a significant amount of recharge requires spreading water over a pretty large surface area. For deeper aquifers sealed off from the surface by impermeable layers, you have to pump water _down_ a well, also at a rate that the well can handle.
...
Some of the cases collected in the study involved intentional efforts to enhance recharge in specific locations to combat this. In Los Angeles, [lines of injection walls](https://pw.lacounty.gov/core-service-areas/water-resources/seawater-barrier/) along the coast are helping to keep saltwater at bay.
...
[![Time series plots from 1920 to 2020 showing land elevations dropping before stabilizing.](https://cdn.arstechnica.net/wp-content/uploads/2026/03/science.adu1370-f5-1024x659.jpg)](https://cdn.arstechnica.net/wp-content/uploads/2026/03/science.adu1370-f5.jpg)

Land subsidence timelines in 15 of the cases studied.

Land subsidence timelines in 15 of the cases studied. Credit: [Jasechko/Science](https://www.science.org/doi/10.1126/science.adu1370)
...
At a fundamental level, this study reminds us that groundwater recovery _has happened_, so it is possible for communities to turn things around. So when we learn from history, we can find some parts we’d actually like to repeat.

Science, 2026. DOI: [10.1126/science.adu1370](http://dx.doi.org/10.1126/science.adu1370) ([About DOIs](http://arstechnica.com/science/news/2010/03/dois-and-their-discontents-1.ars)).

[![Photo of Scott K. Johnson](https://cdn.arstechnica.net/wp-content/uploads/2016/09/sj_2016_prof_450.jpg)](https://arstechnica.com/author/scott-johnson/)

Scott has written about geoscience and energy at Ars as a freelancer since 2011.

[28 Comments](https://arstechnica.com/science/2026/03/a-bit-of-good-news-its-possible-to-turn-around-a-groundwater-crisis/#comments "28 comments")

1.  [![Listing image for first story in Most Read: There can (still) be only one: Highlander is 40](https://cdn.arstechnica.net/wp-content/uploads/2026/03/highlander22-768x432-1772826095.jpg)](https://arstechnica.com/culture/2026/03/there-can-still-be-only-one-highlander-is-40/)
