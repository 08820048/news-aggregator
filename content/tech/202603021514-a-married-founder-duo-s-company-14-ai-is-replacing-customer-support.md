...
published: "2026-03-02T15:14:36.000Z"
category: "tech"
summary: "14.ai also launched a consumer brand to understand how much AI can handle customer support tasks."
---
The customer service industry is in a bit of flux, thanks to AI. [Investors](https://www.financialexpress.com/life/technology-it-and-bpo-services-will-disappear-in-next-5-years-due-to-ai-warns-tech-billionaire-vinod-khosla-4144549/) and [corporate leaders](https://m.economictimes.com/tech/information-tech/bpo-sector-ripe-for-ai-disruption-says-tcs-ceo-k-krithivasan/articleshow/122445725.cms) have rung alarm bells for the BPO (Business Process Outsourcing) industry. On the other hand, AI-powered customer support startups such as Decagon, Parloa, and Sierra have picked up millions of dollars in funding from venture capitalists.

[14.ai](https://14.ai/), a Y-Combinator-backed startup, is taking an approach of building an AI-native agency that has replaced legacy customer support teams at many startups it has worked with.
...
The startup was founded by a married duo, Marie Schneegans and Michael Fester. The two met in Paris more than a decade ago and went on to build separate companies. Schneegans was a co-founder at [corporate intranet company Workwell](https://techcrunch.com/2017/06/16/workwell-wants-to-make-your-corporate-intranet-suck-less/). Fester previously founded Snips, a company that worked on local first assistants for smart devices, which [was acquired by Sonos in 2019](https://techcrunch.com/2019/11/20/sonos-acquires-voice-assistant-startup-snips-potentially-to-build-out-on-device-voice-control/).
...
The company wants to take off three key items from a startup’s balance sheet, including ticketing systems, AI software add-ons, and human labor costs. The startup caters to many clients in different sectors such as luxury skin care brand [Yon-KA](https://us.yonka.com/), smart glasses maker [Brilliant Labs](https://us.yonka.com/), and [lighting company Creative Lighting](https://creative.lighting/).

The startup also wants to improve its own product by experimenting and letting AI handle most tasks. For that, it runs a [GloGlo](http://gloglo.com/), a glucose gummies brand for Type 1 diabetics, and tries to operate autonomously with AI.
...
Notably, AI-powered agencies are one of the things Y-Combinator mentioned in its [requests for startups in 2026](https://www.ycombinator.com/rfs).
