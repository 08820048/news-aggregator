...
Lately, that does not appear to be a particularly unique take. Indeed, it’s not clear what will cure the perception that, despite a recent [$122 billion funding round](https://openai.com/index/accelerating-the-next-phase-ai/) and its [upcoming IPO](https://www.cnbc.com/2026/04/08/openai-ipo-sarah-friar-retail-investors.html), OpenAI has lost its footing—or, at the very least, seems increasingly unsure of what the next step is.

Part of the problem may be a perception that the company lacks focus. Last month, OpenAI abandoned a number of long simmering side-quests (including its AI [video generator Sora](https://techcrunch.com/2026/03/29/why-openai-really-shut-down-sora/) and a troubled plan to launch [a “sexy” version of ChatGPT](https://techcrunch.com/2026/03/26/openai-abandons-yet-another-side-quest-chatgpts-erotic-mode/)), locking in instead on the focuses of business and coding services. In the meantime, a number of developments, including [a recent New Yorker piece](https://www.newyorker.com/magazine/2026/04/13/sam-altman-may-control-our-future-can-he-be-trusted) that questioned whether the company’s CEO, Sam Altman, was trustworthy or not, have spurred a certain [amount of negative buzz](https://www.semafor.com/article/04/08/2026/why-openais-slowdown-isnt-as-bad-as-it-looks) around the company. The company’s work with the Trump administration hasn’t won it any friends either, nor has its decision to inject advertising into ChatGPT.
...
The controversies and vacillations can make OpenAI’s seem reactive rather than strategic, as if it’s simply responding to events rather than shaping them. That said, when it comes to prominence and revenue, OpenAI and Anthropic are neck and neck — or at least, that’s how it looks, with some data suggesting that [Anthropic is catching up among business users](https://www.ft.com/content/abb93a6f-9060-4095-8045-84b97d394a4c?syn-25a6b1a6=1). The Wall Street Journal [recently analyzed](https://www.wsj.com/tech/ai/openai-anthropic-ipo-finances-04b3cfb9) their finances, showing that the two companies were “the fastest-growing businesses in the history of tech.” In that sense, perhaps “falling off” for OpenAI just means it’s not the undisputed champ anymore. It has competition — which, in most industries, is normal.

Techcrunch event

San Francisco, CA | October 13-15, 2026

If anything, it remains clear that OpenAI is determined to do what it takes to remain dominant. This week, the company announced [a new $100 subscription tier to ChatGPT](https://techcrunch.com/2026/04/09/chatgpt-pro-plan-100-month-codex/) with substantially more access to Codex, its coding tool. The move seems clearly designed to spur broader use of tool while hopefully peeling users away from Claude Code.
