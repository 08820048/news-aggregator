...
Japan’s Ministry of Economy, Trade and Industry [said](https://newsonjapan.com/article/148670.php) in March 2026 that it aims to build a domestic physical AI sector and capture a 30% share of the global market by 2040. The country already holds a strong position in industrial robotics, with Japanese manufacturers accounting for about 70% of the global market in 2022, [according to the ministry](https://journal.meti.go.jp/keizaiword/41179/).
...
Japan’s [demographic](https://www.worldometers.info/world-population/japan-population/) crunch is accelerating. The population declined for [a 14th straight year in 2024](https://www.nippon.com/en/japan-data/h02382/); those of working age [make up just to 59.6%](https://www.newsonair.gov.in/japan-records-sharpest-population-decline-labour-shortage-deepens-amid-ageing-crisis/) of the total, a share projected to shrink by nearly 15 million over the next 20 years, Doh pointed out. It’s already reshaping how companies operate: [a 2024 Reuters/Nikkei survey](https://www.reuters.com/technology/artificial-intelligence/more-than-40-japanese-companies-have-no-plan-make-use-ai-2024-07-17/) found labor shortages are the main force pushing Japanese firms to adopt AI.
...
The government is putting money behind the push. Under Prime Minister Sanae Takaichi, Japan has committed about [$6.3 billion to strengthen core AI capabilities](https://www.franklintempleton.com/articles/2026/etf/where-global-economies-sit-in-the-ai-stack), advance robotics integration and support industrial deployment.

The shift from experimentation to real deployment is already underway. Industrial automation remains the most advanced segment, with Japan [installing tens of thousands of robots each year](https://ifr.org/ifr-press-releases/news/japans-car-industry-has-highest-robot-installations-in-five-years), particularly in the automotive sector. Newer applications are also beginning to gain traction, Doh said.
...
Companies like [SoftBank](https://www.softbank.jp/en/corp/technology/research/topics/213/?adid=sbn) are already applying physical AI in practice, combining vision-language models with real-time control systems to enable robots to interpret environments and execute complex tasks autonomously.
