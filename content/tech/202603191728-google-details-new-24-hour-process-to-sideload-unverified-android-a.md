...
published: "2026-03-19T17:28:26.000Z"
category: "tech"
summary: "The \"advanced flow\" will be available before verification enforcement begins later this year."
---
Set a timer
...
Google is planning big changes for Android in 2026 aimed at combating malware across the entire device ecosystem. Starting in September, Google will begin [restricting application sideloading](https://arstechnica.com/gadgets/2025/08/google-will-block-sideloading-of-unverified-android-apps-starting-next-year/) with its developer verification program, but not everyone is on board. Android Ecosystem President Sameer Samat tells Ars that the company has been listening to feedback, and the result is the newly unveiled advanced flow, which will allow power users to skip app verification.

With its new limits on sideloading, Android phones will only install apps that come from verified developers. To verify, devs releasing apps outside of Google Play will have to provide identification, upload a copy of their signing keys, and pay a $25 fee. It all [seems rather onerous](https://arstechnica.com/gadgets/2026/03/with-developer-verification-googles-apple-envy-threatens-to-dismantle-androids-open-legacy/) for people who just want to make apps without Google’s intervention.

Apps that come from unverified developers won’t be installable on Android phones—unless you use the [new advanced flow](https://android-developers.googleblog.com/2026/03/android-developer-verification.html?m=1), which will be buried in the developer settings.
...
[![bypass advanced flow UI](https://cdn.arstechnica.net/wp-content/uploads/2026/03/advanced-flow.png)](https://cdn.arstechnica.net/wp-content/uploads/2026/03/advanced-flow.png)
...
[![](https://cdn.arstechnica.net/wp-content/uploads/2026/03/sideloading-choice.png)](https://cdn.arstechnica.net/wp-content/uploads/2026/03/sideloading-choice.png)
...
Android users in most of the world don’t have to worry about developer verification yet, but that day is coming. In September, verification enforcement will begin in Brazil, Singapore, Indonesia, and Thailand. Impersonation and guided scams are more common in these regions, so Google is starting there before expanding verification globally next year. Google has stressed that the advanced flow will be available _before_ the initial rollout in September.
...
[109 Comments](https://arstechnica.com/gadgets/2026/03/google-details-new-24-hour-process-to-sideload-unverified-android-apps/#comments "109 comments")
