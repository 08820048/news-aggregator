---
title: "The Big Debate: What role should AI have in video game narrative?"
source: "Lewis Packwood"
url: "https://www.gamesindustry.biz/the-big-debate-what-role-should-ai-have-in-video-game-narrative"
published: "2026-03-20T10:22:35.000Z"
category: "gaming"
...
Thomas Keane (on the right above) is the co-founder of Meaning Machine, which is developing the AI-powered game [Dead Meat](https://store.steampowered.com/app/2628740/Dead_Meat/), where the player interrogates a murder suspect by asking them anything they like. Previously, he developed the voice-controlled adventure game [Unknown Number](https://store.steampowered.com/app/1692340/Unknown_Number_A_First_Person_Talker/), and has worked with the immersive theatre company Punchdrunk.

_GamesIndustry.biz_ paired them together to debate what kind of role AI should play in game narrative – and the results were fascinating, leading to a deep discussion over how AI can be ethical, where the lines should be drawn, and how individuals within the games industry need to engage with AI use in order to drive its direction.
...
![Total War: Warhammer 3](https://www.gamesindustry.biz/1_3_pS1b25b.jpg)

Daniel Griliopoulos worked on Total War: Warhammer 3. | Image credit: Creative Assembly/Feral Interactive/Sega
...
![Dead Meat](https://www.gamesindustry.biz/Dead-Meat_CnI2gcf.jpg)

Dead Meat sees the player interrogating murder suspects. | Image credit: Meaning Machine
...
![Caves of Qud](https://www.gamesindustry.biz/caves-of-qud-release-date-1.jpg)

Caves of Qud uses procedural generation to create worlds. | Image credit: Freehold Games/Kitfox Games
...
**DG:** There are games like [Caves of Qud](https://www.gamesindustry.biz/keeping-trolls-out-of-the-caves-of-qud-community), which have that handcrafted core storyline, and they already have procedural content around the outside. Obviously that's not generative AI, it's generated by humans, but procedural content is something that's amenable to being expanded by AI.
...
In terms of power usage, it's [only creeping up at the moment](https://www.iea.org/reports/energy-and-ai/energy-demand-from-ai). But as Thomas says, if we can work out ways of making models that work on device, models that work locally, that don't have this constant network traffic, great.
