---
title: "How to unlock all classes (collars) in Mewgenics"
source: "Ford James"
url: "https://www.polygon.com/mewgenics-classes-collars-how-to-unlock/"
published: "2026-02-14T00:51:46.000Z"
category: "gaming"
summary: "There are 13 collars in Mewgenics. Each collar will make your cat a specific class. Here's how to unlock collars and what each class does."
---
...
Updated  Feb 13, 2026, 7:51 PM EST

Four to start, nine more to unlock

   ![A zoomed in shot of Mewgenics, with a group of fleas surrounding an enemy.](https://static0.polygonimages.com/wordpress/wp-content/uploads/2026/02/mewgenics-classes-header.jpg?&fit=crop&w=1600&h=900)Image: Edmund McMillen/Tyler Glaiel

There are 13 _[Mewgenics](https://www.polygon.com/game/mew-genics/3325/)_ **classes** in this cat breeding turn-based roguelike, although you'll only start the game with four. Knowing how each of the classes works, alongside what the best ones are and how to unlock them in the first place, is key to progressing through this incredibly deep and layered game from the creator of _The Binding of Isaac_.

So whether you've just started the game and you want to know what's coming up for you or you want to know how to unlock a specific one, here are the details for the different **_Mewgenics_** **classes**.

**Update (Feb. 13)**: We've updated this guide with information about the Psychic class.

* * *

## Mewgenics classes and how to unlock them

Classes in _Mewgenics_ are represented by collars. Here's a list of the first 11 and how to unlock them. We're still working out how to unlock the remaining two, but we'll update this guide once we can verify them ourselves.
